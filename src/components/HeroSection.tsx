...
const AnimatedWord = () => {
  ...
  return <span className="text-orange-500 inline-block min-w-[200px] transition-opacity duration-500">
      {words[currentIndex]}
    </span>;
};
export const HeroSection = () => {
  return <section className="relative w-full min-h-screen flex items-center overflow-hidden pb-0">
      {/* Video Background - positioned to align with bottom */}
      <video autoPlay muted loop playsInline className="absolute inset-0 w-full h-full object-cover object-[center_70%] z-0">
