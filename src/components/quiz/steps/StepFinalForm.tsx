...
export function StepFinalForm() {
  ...
  return (
    <div className="space-y-6">
      ...
      <QuizSummary expanded className="mb-4" />

      {/* User info summary */}
      <div className="bg-muted/30 rounded-xl p-4 border border-border">
        <p className="text-sm text-muted-foreground mb-2">Seus dados:</p>
        <div className="space-y-1 text-sm">
          ...
          {state.company && <p className="text-muted-foreground">{state.company}</p>}
        </div>
      </div>
