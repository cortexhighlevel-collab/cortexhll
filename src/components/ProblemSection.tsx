      ...
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
          ...
          <div className="lg:col-span-7 flex flex-col gap-6">
            ...
            <div className="relative overflow-hidden rounded-3xl bg-zinc-900 min-h-[350px] flex-1 flex flex-col group hover:bg-zinc-800 transition-colors duration-300">
              {/* Tags at top left */}
