...
const ProblemSection = () => {
  ...
  return <section className="w-full px-5 md:px-12 py-16 md:py-24 overflow-hidden">
      <div className="max-w-[1400px] mx-auto">
        <motion.div className="flex flex-col items-center text-center gap-3 mb-16" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5 }} variants={fadeInUp}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center mb-12 lg:mb-20">
          <motion.div className="relative overflow-hidden rounded-3xl bg-zinc-900 min-h-[350px] lg:min-h-[400px] flex flex-col group hover:bg-zinc-800 transition-colors duration-300 border border-[#f06800]" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={fadeInLeft}>
          ...
          <motion.div className="flex flex-col justify-center" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5 }} variants={fadeInRight}>
        ...
        {/* Row 2 */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center mb-12 lg:mb-20">
          <motion.div className="flex flex-col justify-center order-2 lg:order-1" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.5 }} variants={fadeInLeft}>
            <h3 className="text-2xl md:text-3xl lg:text-4xl font-medium text-foreground leading-tight mb-4 font-dm">
          ...
          <motion.div className="relative overflow-hidden rounded-3xl min-h-[350px] lg:min-h-[400px] flex flex-col group transition-colors duration-300 order-1 lg:order-2 border border-[#f06800]" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={fadeInRight}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          <motion.div className="relative overflow-hidden rounded-3xl min-h-[350px] lg:min-h-[400px] flex flex-col group transition-all duration-300 cursor-pointer border border-[#f06800]" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={fadeInLeft}>
