        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 min-h-[500px]">
          ...
          amount: 0.3
            ...
            <div className="flex gap-3 mt-8">
              ...
              <button onClick={handleNext} className="w-12 h-12 rounded-full bg-foreground flex items-center justify-center hover:bg-foreground/90 transition-all duration-300">
