      ...
      <div className="max-w-[1800px] mx-auto">
        ...
        <div className="bg-academy-mint card-radius p-6 md:p-10 lg:p-12 bg-primary-foreground">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-6">
            ...
            <div className="card-radius p-6 md:p-8 flex flex-col bg-secondary-foreground">
              <div className="mb-6">
                <span className="tag-pill text-primary-foreground bg-[#f06800]">COMUNIDADE DE CRIATIVOS</span>
              </div>
              <p className="text-lg md:text-xl leading-relaxed text-primary-foreground">
            ...
            <div className="card-radius p-6 md:p-8 flex flex-col justify-between bg-secondary-foreground">
              <div className="flex items-start justify-between mb-6">
                ...
                <span className="tag-pill bg-academy-gray text-xs text-secondary-foreground bg-[#f06800]">CERTIFICADO</span>
              </div>
              <p className="text-lg md:text-xl leading-relaxed text-primary-foreground">
