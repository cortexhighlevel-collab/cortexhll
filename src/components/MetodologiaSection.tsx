  ...
  return <section id="metodologia" className="w-full px-5 md:px-12 py-10 rounded-b-[40px] bg-secondary">
      <div className="max-w-[1200px] mx-auto">
        ...
        <div className="card-radius p-4 md:p-6 lg:p-8 bg-secondary">
          ...
          {/* Quote Block */}
          <div className="video-radius overflow-hidden p-8 md:p-12 mb-5 md:mb-8 flex flex-col items-center justify-center bg-secondary-foreground text-primary-foreground w-full py-[80px]">
