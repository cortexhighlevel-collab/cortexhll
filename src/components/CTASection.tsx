...
// Animation variants - Scale from center
...
const CTASection = () => {
  return <div id="contato" className="w-full min-h-screen text-black flex items-center justify-center font-dm antialiased selection:bg-[#f06800] selection:text-white light-dotted-fade-in">
      {/* Container principal horizontal (flex-row em telas grandes) */}
      <motion.div 
        className="w-full max-w-[1280px] relative z-20 flex flex-col lg:flex-row items-center lg:items-end justify-between gap-12 lg:gap-24 border-y border-black/10 py-12 lg:py-20 px-8"
        initial="hidden"
        whileInView="visible"
      ...
      >
        ...
        <motion.div className="flex flex-col gap-8 lg:max-w-[60%] flex-shrink-0" variants={slideUp}>
          {/* Header Line */}
        ...
        <motion.div className="flex flex-col gap-8 w-full lg:w-auto lg:min-w-[420px] flex-grow" variants={pulseIn}>
          {/* Box de Ação */}
          <div className="flex flex-col gap-4">
