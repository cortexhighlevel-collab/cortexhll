      ...
      <div className="w-full max-w-[1280px] bg-[#f06800] relative z-10 flex flex-col lg:flex-row items-center lg:items-end justify-between gap-12 lg:gap-24 border-y border-white/10 py-12 lg:py-20">
        ...
        <div className="flex flex-col gap-8 lg:max-w-[60%] flex-shrink-0">
          ...
          <div className="flex items-center gap-4">
            ...
            <h4 className="text-[28px] lg:text-[38px] font-light tracking-[-0.04em] text-white leading-[1.1]">
              Diagnóstico
            </h4>
          </div>

          <div className="flex flex-col gap-4">
            <h4 className="text-[36px] lg:text-[56px] leading-[1.05] font-normal tracking-[-0.04em] text-white">
              O custo de não agir é maior que o investimento
            </h4>
            <p className="text-[18px] lg:text-[22px] leading-[1.5] text-white/80 tracking-[-0.02em] max-w-xl">
          ...
          <div className="flex flex-wrap gap-3 mt-2">
            <div className="px-5 py-1.5 rounded-full border border-white/20 bg-white/10 backdrop-blur-md flex items-center gap-2">
              <span className="text-xs">🎯</span>
              <span className="text-xs text-white uppercase tracking-wider font-medium">Diagnóstico Gratuito</span>
            </div>
            <div className="px-5 py-1.5 rounded-full bg-white border border-white">
              <span className="text-xs text-black uppercase tracking-wider font-medium">Sua Marca</span>
            </div>
          </div>
        </div>
        ...
        <div className="flex flex-col gap-8 w-full lg:w-auto lg:min-w-[420px] flex-grow">
          ...
          <div className="flex flex-col gap-4">
            <form className="w-full relative" onSubmit={(e) => e.preventDefault()}>
              <button 
                type="submit"
                className="group w-full bg-[#E7F99A] text-black rounded-full h-[72px] pl-8 pr-4 flex items-center justify-between hover:bg-[#dcec88] hover:scale-[1.01] active:scale-[0.99] transition-all duration-300 ease-out cursor-pointer shadow-[0_0_30px_rgba(231,249,154,0.15)]"
              >
            ...
            <div className="flex items-center justify-center lg:justify-end gap-4 text-sm text-white/60">
              <span>Ou fale direto:</span>
              <a href="#" className="hover:text-[#E7F99A] transition-colors flex items-center gap-1">
