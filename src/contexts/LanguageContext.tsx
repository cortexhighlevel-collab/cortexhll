...
const translations: Record<Language, Record<string, string>> = {
  pt: {
    ...
    "cases.project8.desc": "Landing page impactante para a Jovem Hub. Design poderoso que captura a essência da comunidade e conecta jovens empreendedores.",
    "cases.project8.r1": "Design impactante",
    "cases.project8.r2": "Conexão com o público",
    "cases.project8.r3": "Comunidade engajada",
    "cases.project9.desc": "Site cinematográfico para a Scolty Vision. Cada scroll é uma experiência visual que converte visitantes em clientes para produção de vídeos de elite.",
    ...
    "cases.project11.desc": "Site futurista e funcional para a XScale AI. Transmite inovação desde o primeiro pixel e comunica consultoria estratégica em IA com clareza.",
    "cases.project11.r1": "Design futurista",
    "cases.project11.r2": "UX estratégico",
    "cases.project11.r3": "Inovação visual",
    "cases.project12.desc": "Landing page clean e profissional para a RentFy. Transmite simplicidade e confiança para hosts da Turo com alta taxa de conversão.",
  ...
  en: {
    ...
    "cases.project8.desc": "Impactful landing page for Jovem Hub. Powerful design that captures the community's essence and connects young entrepreneurs.",
    "cases.project8.r1": "Impactful design",
    "cases.project8.r2": "Audience connection",
    "cases.project8.r3": "Engaged community",
    "cases.project9.desc": "Cinematic website for Scolty Vision. Every scroll is a visual experience that converts visitors into clients for elite video production.",
    ...
    "cases.project11.desc": "Futuristic, functional website for XScale AI. Conveys innovation from the first pixel and communicates strategic AI consulting with clarity.",
    "cases.project11.r1": "Futuristic design",
    "cases.project11.r2": "Strategic UX",
    "cases.project11.r3": "Visual innovation",
    "cases.project12.desc": "Clean, professional landing page for RentFy. Conveys simplicity and trust for Turo hosts with high conversion rate.",
